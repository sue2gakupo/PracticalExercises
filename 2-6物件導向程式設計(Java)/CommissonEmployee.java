public class CommissonEmployee extends Employee {
    ...
    CommissonEmployee(String name, String mobile,int grossSales, double commissionRate, int baseSalary) {
        super(name, mobile);
    ...
    public String toString(){
        return "Commisson員工基本資料 姓名=" + this.getName() + ", 手機=" + this.getMobile();
    }
