...
namespace BondleApplication.Areas.UserCreator.Controllers
{
    ...
    public class ProductSeriesController : Controller
    {
        ...
        // GET: UserCreator/ProductSeries/Details/5
        ...
        // GET: UserCreator/ProductSeries/Create
        ...
        // POST: UserCreator/ProductSeries/Create
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(ProductSeries productSeries)
        {
            if (ModelState.IsValid)
            {
        ...
        public IActionResult GetByCreatorId(string creatorId)
        {
            var productSeries = _context.ProductSeries
                .FirstOrDefault(p => p.CreatorID == creatorId);

            if (productSeries == null)
                productSeries = new ProductSeries { CreatorID = creatorId };

            return PartialView("_ProductSeriesForm", productSeries);
        }

        public IActionResult GetSeriesList()
        {
            var series = _context.ProductSeries
                .Select(p => new { p.SeriesID, p.SeriesName })
                .Distinct()
                .ToList();
        ...
        // GET: UserCreator/ProductSeries/Edit/5
        ...
        // POST: UserCreator/ProductSeries/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: UserCreator/ProductSeries/Delete/5
        ...
        // POST: UserCreator/ProductSeries/Delete/5
